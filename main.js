...
var $author$project$Main$YouAreRight = {$: 'YouAreRight'};
				...
				[
					...
					_List_fromArray(
						[
							...
							$elm$svg$Svg$Attributes$fill('#4b4b4b')
						]),
					_List_Nil),
					A2(
					$elm$svg$Svg$circle,
					...
					_List_fromArray(
						[
							...
							$elm$svg$Svg$Attributes$points('0,0 4,0 4,20 20,20 20,0 24,0 24,24 0,24')
						]),
					_List_Nil)
				]))
		]));
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A2($elm$html$Html$Attributes$style, 'min-width', '600px')
			]),
		_List_fromArray(
			[
				A2(
